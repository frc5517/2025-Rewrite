...
public class SimulatedRobots extends SubsystemBase {
    ...
    public static final SimulatedRobots[] instances = new SimulatedRobots[MapleConstants.templateInstances];
    public SimulatedRobots() {
    }



    public SimulatedRobots addOpponent(SmartOpponent opponent) {
