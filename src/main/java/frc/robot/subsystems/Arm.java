...
public class Arm extends SubsystemBase {
    ...
    private final SmartMotorControllerConfig motorConfig = new SmartMotorControllerConfig(this)
            ...
            .withTelemetry(HardwareConstants.kArmName + "Motor ID: " + HardwareConstants.kArmMotorID, HardwareConstants.kVerbosity)
            ...
            // Absolute encoder attached to the SparkMax running the arm.
    ...
    private final ArmConfig m_config = new ArmConfig(motor)
            ...
            .withTelemetry(HardwareConstants.kArmName, HardwareConstants.kVerbosity)
    ...
    public static final class SimConstants {
        ...
        public static final class kMechanismPosition {
            public static final Distance kXFrontPositive = Inches.of(12);
            public static final Distance kYLeftPositive = Inches.of(0.0);
            public static final Distance kZUpPositive = Inches.of(44);
        }
    }
}